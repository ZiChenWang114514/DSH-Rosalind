...
description: Use ProteomeXchange through DSH-Rosalind's typed public-service request tool.
---

# ProteomeXchange

Use `database_request` with `provider: "proteomexchange"`. Select the source requested by the user. Do not silently replace a requested service with another provider, mirror, archive, or identifier resolver.
