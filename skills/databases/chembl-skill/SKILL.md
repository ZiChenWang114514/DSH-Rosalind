---
name: chembl-skill
description: Use ChEMBL through DSH-Rosalind's typed public-service request tool.
---

# ChEMBL

Use `database_request` with `provider: "chembl"`. Select the source requested by the user. Do not silently replace a requested service with another provider, mirror, archive, or identifier resolver.
