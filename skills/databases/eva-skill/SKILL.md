---
name: eva-skill
description: Use European Variation Archive through DSH-Rosalind's typed public-service request tool.
---

# European Variation Archive

Use `database_request` with `provider: "eva"`. Select the source requested by the user. Do not silently replace a requested service with another provider, mirror, archive, or identifier resolver.
