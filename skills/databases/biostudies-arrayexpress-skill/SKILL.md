...
description: Use BioStudies and ArrayExpress through DSH-Rosalind's typed public-service request tool.
---

# BioStudies and ArrayExpress

Use `database_request` with `provider: "biostudies-arrayexpress"`. Select the source requested by the user. Do not silently replace a requested service with another provider, mirror, archive, or identifier resolver.
