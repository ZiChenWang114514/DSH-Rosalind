---
name: ncbi-pmc-skill
description: Use NCBI PubMed Central through DSH-Rosalind's typed public-service request tool.
---

# NCBI PubMed Central

Use `literature_request` with `provider: "ncbi-pmc"`. Select the source requested by the user. Do not silently replace a requested service with another provider, mirror, archive, or identifier resolver.
