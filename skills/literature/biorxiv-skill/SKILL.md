---
name: biorxiv-skill
description: Use bioRxiv and medRxiv through DSH-Rosalind's typed public-service request tool.
---

# bioRxiv and medRxiv

Use `literature_request` with `provider: "biorxiv"` or `provider: "medrxiv"`. Select the source requested by the user. Do not silently replace a requested service with another provider, mirror, archive, or identifier resolver.
