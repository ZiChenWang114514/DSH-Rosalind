# Codex showcase lesson: Workflow archive and restore

## Session prompt

Use $showcase-teacher to import and teach the ready showcase `ngs-workflow-archive` (Workflow archive and restore). Inspect its README, manifest, prompt, inputs, outputs, previews, and provenance records. Clearly distinguish source observations, computed results, scientific interpretation, and limitations, and show the preview when useful.

## Catalogue record

- Showcase ID: `ngs-workflow-archive`
...
- Covered operations: `ngs-analysis-workbench.archive_workflow`, `ngs-analysis-workbench.list_workflows`, `ngs-analysis-workbench.restore_workflow`, `rosalind.rosalind_open`
- Rosalind tasks: none recorded
- Actual tools: `mcp__ngs_analysis_workbench__archive_workflow`, `mcp__ngs_analysis_workbench__list_workflows`, `mcp__ngs_analysis_workbench__restore_workflow`, `mcp__rosalind__rosalind_open`
- Summary: How can a disposable saved workflow be archived and restored safely?
- Recorded next step: Repeat the case-owned workflow archive and restore cycle, confirming the same version digest after reactivation.
- Plugin guide: `showcases/ngs-analysis-workbench/README.md`

## Repository files to inspect

- case guide: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/README.md`
- case manifest: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/showcase.json`
- teaching prompt: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/prompt.md`
- input: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/inputs/public-source.md`
- output: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/outputs/workbench-archive-restore.json`
- output: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/outputs/rosalind-open-observation.json`
- output: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/outputs/session-bundle.md`
- output: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/outputs/operation-evidence.json`
- preview: `showcases/ngs-analysis-workbench/cases/ngs-workflow-archive/previews/preview.svg`
