# Codex showcase lesson: Variant-to-pathway evidence chain

## Session prompt

Use $showcase-teacher to import and teach the ready showcase `rosalind-variant-pathway` (Variant-to-pathway evidence chain). Inspect its README, manifest, prompt, inputs, outputs, previews, and provenance records. Clearly distinguish source observations, computed results, scientific interpretation, and limitations, and show the preview when useful.

## Catalogue record

- Showcase ID: `rosalind-variant-pathway`
...
- Actual tools: `public ClinVar, Ensembl, and Reactome records`, `local deterministic identifier-path validation`, `Rosalind Workbench mcp__rosalind__rosalind_open`
- Summary: How can one public variant be connected to gene and pathway evidence without overstating causality?
- Recorded next step: Revalidate the rs7903146 C-to-T path across ClinVar, Ensembl, and Reactome without converting association into causality.
- Plugin guide: `showcases/rosalind-workbench/README.md`

## Repository files to inspect

- case guide: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/README.md`
- case manifest: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/showcase.json`
- teaching prompt: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/prompt.md`
- input: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/inputs/public-source.md`
- output: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/outputs/verification-receipt.json`
- output: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/outputs/rosalind-open-observation.json`
- output: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/outputs/teaching-bundle.md`
- preview: `showcases/rosalind-workbench/cases/rosalind-variant-pathway/previews/preview.svg`

## Public sources

- https://www.ncbi.nlm.nih.gov/clinvar/variation/7413/
- https://rest.ensembl.org/variation/homo_sapiens/rs7903146
- https://reactome.org/content/detail/R-HSA-201923
- https://reactome.org/content/detail/R-HSA-201722
...
# rs7903146 C>T to TCF7L2 and WNT

Teach the allele-specific evidence path from ClinVar Variation ID 7413 and GRCh38 `10:112998590-C-T` to TCF7L2, Reactome entity `R-HSA-201923`, and pathway `R-HSA-201722`. Keep the excluded C>G allele separate, distinguish public observations from the four-node local path calculation, and do not infer that identifier connectivity proves variant mechanism or clinical causality. Inspect `outputs/rosalind-open-observation.json` as a genuine chooser-readiness record that performed no variant or pathway analysis.
