...
.sv-scene-toolbar { position: absolute; z-index: 2; top: 7px; left: 7px; display: flex; gap: 4px; }
.sv-scene-toolbar span { padding: 3px 6px; border: 1px solid rgba(255,255,255,.11); border-radius: 999px; background: rgba(5,9,11,.54); color: rgba(255,255,255,.7); font-size: 7px; text-transform: uppercase; }
.sv-scene svg { position: relative; z-index: 1; width: 100%; height: 180px; }
...
.sv-slide-map svg { width: calc(100% - 18px); height: 160px; filter: saturate(.72); }
