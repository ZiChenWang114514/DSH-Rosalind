...
All 100 showcases support lesson and replay from reviewed records. Only the 23 IDs in `showcases/reproduction-routes.json` have registered fresh-run reproduction routes and may declare `reproduce`; keep that file, the host routes, generated catalogue, and documentation consistent.
